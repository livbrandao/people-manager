...
export default function EmployeeForm() {
  const [formData, setFormData] = useState({
    ...
    activities: [
      {
        activity: "",
        epis: [], // Changed from epi to epis array to store multiple EPIs
      },
    ],
    healthCertificate: "",
  });
    ...
    <div className="px-6 py-8">
      ...
      <div className="mb-4 p-2 border border-greyBlue rounded-xl flex justify-between items-center shadow">
        ...
        <div className="flex items-center">
          ...
          >
            <span className={`text-xs font-light pl-5 tracking-wide text-dark`}>
          ...
          <>
            {formData.activities.map((activity, index) => (
              ...
              >
                ...
                <button
                  type="button"
                  className="w-full py-2 text-greyBlue border border-greyBlue rounded-xl text-sm mb-3"
                  onClick={addActivity}
                >
      ...
      <div className="my-4 border border-greyBlue shadow rounded-xl p-3">
        ...
        <div className="mb-2 p-2 border border-greyBlue rounded-xl flex justify-between items-center">
          <span className="text-sm">Documento 1.png</span>
          <button type="button">
            <svg
        ...
        <button
          type="button"
          className="w-full py-2 text-greyBlue border border-greyBlue rounded-xl text-sm"
        >
          Selecionar arquivo
        </button>
      </div>
